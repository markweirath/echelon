  ...
  <body>
    <div id="wrapper">
      ...
      <table width="100%" class="tabeluitleg" cellspacing="0" cellpadding="0">
        <tr>
          <td align="center">
            <strong>Admin kicks.</strong>
            <br>You are viewing the kicks issued by admins. Clients can reconnect immediately.
          </td>
        </tr>
      </table>
